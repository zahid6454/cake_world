                            ...
                            <div class="row">
                                <div class="col-xs-6">
                                    <address>
                                        ...
                                        <strong style="font-size: 18px;">Delivary Address : </strong><text style="font-size:17px"><?php echo $address ?></text><br>

                                        <br>
                                        <strong style="font-size: 18px;">Order Date : </strong><text style="font-size:17px"><?php echo date('d-m-Y', strtotime($date)); ?></text><br>
                                        <strong style="font-size: 18px;">Order Time : </strong><text style="font-size:17px"><?php echo date('h:i A', strtotime($date)); ?></text><br><br>
                                    </address>
                                </div>
                            </div>
                        </div>
