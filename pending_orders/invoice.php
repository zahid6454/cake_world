                    ...
                    <form method="post" action="invoice.php">
                        <div class="row">
                            ...
                            <div align="center" class="col-md-3">
                                <a href="invoice_fetch.php?orderid=<?php echo $orderid ?>&command=1" name="deliever_button" id="deliever_button">Order Delivered</a>
                                <br><br>
                            </div>
                            <div class="col-md-2"></div>
                            <div align="center" class="col-md-3">
                                <a href="invoice_fetch.php?orderid=<?php echo $orderid ?>&command=0" name="failed_button" id="failed_button">Order Failed</a>
                            </div>
                            <div class="col-md-2"></div>
                        </div>
                    </form>
