...
$query = "SELECT COUNT(*) AS total FROM product WHERE type='Birthday Cake'";
...
$query = "SELECT COUNT(*) AS total FROM product WHERE type='Wedding Cake'";
...
$query = "SELECT COUNT(*) AS total FROM product WHERE type='Cheese Cake'";
...
$query = "SELECT COUNT(*) AS total FROM product WHERE type='Eggless Cake'";
...
$query = "SELECT COUNT(*) AS total FROM product WHERE type='Diabetes Cake'";
        ...
        <div class="container">
            ...
            <div class="sidebar col-md-3">
                        ...
                        <li>
                        	<a>
                            	<article>
                                    ...
                                    <div class="list-arrows-value"><?php echo $totalcakes ?></div>
                                </article>
                           	</a>
                       	</li>
                        ...
                        <li>
                        	<a>
                            	<article>
                                    ...
                                    <div class="list-arrows-value"><?php echo $totalBdaycakes ?></div>
                                </article>
                           	</a>
                       	</li>
                       	...
                       	<li>
                        	<a>
                            	<article>
                                    ...
                                    <div class="list-arrows-value"><?php echo $totalwedcakes ?></div>
                        		</article>
                          	</a>
                        </li>
                      	...
                      	<li>
                        	<a>
                            	<article>
                                    ...
                                    <div class="list-arrows-value"><?php echo $totalchesscakes ?></div>
                        		</article>
                          	</a>
                  		</li>
                        ...
                        <li>
                        	<a>
                            	<article>
                                    ...
                                    <div class="list-arrows-value"><?php echo $totalegglesscakes ?></div>
                        		</article>
                      		</a> 
                        </li>
                      	...
                      	<li>
                        	<a> 
                            	<article>
                                    ...
                                    <div class="list-arrows-value"><?php echo $totaldiabetcakes ?></div>
                        		</article>
                            </a>
                      	</li>
                    </ul>
                ...
                <!--<article class="onscroll-animate">
                    ...
                    <a href="#"><div class="tag">Birthday Cakes</div></a><br>
                    <a href="#"><div class="tag">Wedding Cake</div></a><br>
