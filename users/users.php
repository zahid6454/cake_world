    ...
    <body>
        <div class="all">
                ...
                <div class="page-header-content container">
                    ...
                    <nav id="nav-top" class="nav-top">
                        ...
                        <ul style="float:right;">
                            ...
                            <li><a id="navbar_options" class="" href="users.php">Users</a></li>
            ...
            <div class="container">
                ...
                <div class="container">
                    <div align="center">
                        <h1 style="font-size: 20px;">User Table</h1>
                    </div>
                    <div class="container table-responsive">
                        <div align="center">
                            <div align="center" style="font-size:18px;width:50%;" id="alert_message"></div>
                        </div>
